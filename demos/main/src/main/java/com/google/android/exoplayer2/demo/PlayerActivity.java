...
public class PlayerActivity extends AppCompatActivity
  ...
  public void onDestroy() {
    ...
    try {
      ((DemoApplication) getApplication()).getDownloadTracker().offlineLicenseHelper
          .releaseLicense(offlineAssetKeyId);
    } catch (Exception e) {
  ...
  private void initializePlayer() {
    if (player == null) {
      ...
      String offlineAssetKeyIdStr = this.getSharedPreferences("download", Context.MODE_PRIVATE)
          .getString("offline-id", "");
      byte[] offlineAssetKeyId = Base64.decode(offlineAssetKeyIdStr, Base64.DEFAULT);
      String drmLicenseUrl = "https://uat-p.sky.com/drm/widevine/acquirelicense?bt=7357-5WiLecs7pJlWFH0pv82HlIB3MFczBWxAisPtQM6jae1BTIQJEzS3tUs30T5J0HAlqu7jhG9iG1l2671SCxxJ0Eqe9XllJRKE2sSCpR0FiJ_1NPLrvx82zcG4fhgiPEKOvf1ZXirxnKO1qkKB8IyBc1tD6xCdwZtR6nQrNCYxfikSkqxi0wCaWEIJ7wK1nWCtvU1rGrDH16vaasofmolkJyKLqfchiAqO38g9UEc_UJVbX008Yr0Vq5764Qqy3cs4ZUm1kMewj4UAibEiikOZnGL_YuvKVH63FQ==";
