...
public class DownloadTracker {
  ...
  final HashMap<Uri, byte[]> keySetMap;
  ...
  private final class StartDownloadDialogHelper
    ...
    private void downloadLicence(DrmInitData data) {
      try {
        offlineLicenseHelper = OfflineLicenseHelper.newWidevineInstance(
            "https://uat-p.sky.com/drm/widevine/acquirelicense?bt=7357-5WiLecs7pJlWFH0pv82HlIB3MFczBWxAisPtQM6jae1BTIQJEzS3tUs30T5J0HAlqu7jhG9iG1l2671SCxxJ0Eqe9XllJRKE2sSCpR0FiJ_1NPLrvx82zcG4fhgiPEKOvf1ZXirxnKO1qkKB8IyBc1tD6xCdwZtR6nQrNCYxfikSkqxi0wCaWEIJ7wK1nWCtvU1rGrDH16vaasofmolkJyKLqfchiAqO38g9UEc_UJVbX008Yr0Vq5764Qqy3cs4ZUm1kMewj4UAibEiikOZnGL_YuvKVH63FQ==",
    ...
    public void onClick(DialogInterface dialog, int which) {
      ...
      // with the older versions of exoplayer we will need to parse the sessionKeyDrmInitData
      // from the manifest by ourselves, I have captured that work in my spike branch in DrmInitDataParser class
      downloadLicence(((HlsManifest)downloadHelper.getManifest()).masterPlaylist.sessionKeyDrmInitData.get(0));
